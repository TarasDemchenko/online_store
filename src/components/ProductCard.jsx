...
const ProductCard = ({ product }) => {
  return (
    <div className=" bg-white shadow rounded relative border transform transition-transform duration-300 hover:scale-105">
      ...
      <div className="absolute bottom-4 right-2 flex items-center justify-center w-8 h-8 bg-amber-600 group text-white text-sm rounded-full hover:w-32 hover:bg-amber-700 transition-all ">
